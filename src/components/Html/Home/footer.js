      ...
      <div className='footerContent'>
        <div className='footerHead'>
          <div className='footerVisit'>
            <div
              className='IconVisit'
              background='/public/assets/img/icons/Group (2).png'
            ></div>
            <span><a rel="noopener noreferrer" target="_blank" href="https://www.lg.com/us/business">Visit LG.com</a></span>
          </div>
          <div className='footerInquiry'>
            <div
              className='IconInquiry'
              background='/public/assets/img/icons/Group (3).png'
            ></div>
            <span><a rel="noopener noreferrer" target="_blank" href="https://www.lg.com/us/business/inquiry-to-buy">Inquiry to Buy</a></span>
          </div>
        </div>
        ...
        <div className='footerRights'>
          <span>
            Copyright © 2009-2020 LG Electronics. All Rights Reserved | All
